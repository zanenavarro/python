...
class Receipt_ocr(Util):

    def __init__(self):
        super().__init__()
        #TODO(zane): use food data_class push methods to update food_pantry data structure
        #self.pantry_dc = food_pantry_data_class(food_pantry_path)
